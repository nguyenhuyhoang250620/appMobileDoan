...
class AppStyle {
  static TextStyle titleTopPage = TextStyle(
  ...
  static TextStyle txtInterMedium14Gray901 = TextStyle(
  ...
  static TextStyle txtInterMedium14Indigo900 = TextStyle(
  ...
  static TextStyle txtInterRegular808 = TextStyle(
    color: ColorConstant.indigo900,
    fontSize: getFontSize(
      8.08,
    ),
  ...
  static TextStyle txtInterMedium14Green500 = TextStyle(
